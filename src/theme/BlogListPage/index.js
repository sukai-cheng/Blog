...
function BlogListPage(props) {
  ...
  const description = `不仅仅是JAVA工程师，分享Spring, Java相关的技术以及个人发展、自我提升相关的心得`;
        ...
        <animated.div className="hero">
          <div className="bloghome__intro">
            <animated.h1 style={animatedTexts[0]}>
              Hello! 我是<span className="intro__name">承苏凯</span>
            </animated.h1>
            <animated.p style={animatedTexts[1]}>
              我是一个Java开发工程师，同时也会Vue哦 哈哈哈～，希望自己能开心快乐的撸码
            </animated.p>
...
function SocialLinks({ animatedProps, ...props }) {
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      <a href="https://space.bilibili.com/35977632">
        <BilibiliIcon />
      </a>
      <a href="https://www.linkedin.com/in/sukai-cheng/">
        <FontAwesomeIcon icon={faLinkedin} size="lg" />
      </a>
      <a href="https://github.com/sukai-cheng">
